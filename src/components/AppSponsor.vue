...
<div class="d-flex justify-content-center mt-3 text-center">
    <div>
        <img class="imgn m-auto" src="../assets/logo-footer-football.png" alt="">
...
<div>
    <div class="card shadow shadow-lg" style="width: 18rem;">
        <img src="../assets/news3-1-150x150.png" class="card-img-top" alt="...">
        <span>29.05.2022 - Football</span>
        <div class="card-body">
        <h5 class="card-title fw-bold">Football Rules</h5>
        <p class="card-text">Some quick example text to build on the card  the card's content.</p>
...
<div>
    <div class="card shadow shadow-lg" style="width: 18rem;">
        <img src="../assets/news6-1-300x300.png" class="card-img-top" alt="...">
        <span>29.05.2022 - Football</span>
        <div class="card-body">
        <h5 class="card-title fw-bold">Football Terms</h5>
        <p class="card-text">Some quick example text to build on the card  the card's content.</p>
